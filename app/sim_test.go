...
func BenchmarkSimulation(b *testing.B) {
	...
	simcli.FlagEnabledValue = true //nolint:staticcheck // keeping old simulations

	config := simcli.NewConfigFromFlags()
	config.ChainID = SimAppChainID

	db, dir, logger, skip, err := simtestutil.SetupSimulation(config, "leveldb-app-sim", "Simulation", simcli.FlagVerboseValue, simcli.FlagEnabledValue) //nolint:staticcheck // keeping old simulations
	if skip {
...
func TestFullAppSimulation(t *testing.T) {
	...
	require.Equal(t, "gnovm", app.Name())
...
func TestAppImportExport(t *testing.T) {
	...
	newDB, newDir, _, _, err := simtestutil.SetupSimulation(config, "leveldb-app-sim-2", "Simulation-2", simcli.FlagVerboseValue, simcli.FlagEnabledValue) //nolint:staticcheck // keeping old simulations
	require.NoError(t, err, "simulation setup failed")
...
func TestAppStateDeterminism(t *testing.T) {
	if !simcli.FlagEnabledValue { //nolint:staticcheck // keeping old simulations
		t.Skip("skipping application simulation")
	}
	...
	config.OnOperation = true   //nolint:staticcheck // keeping old simulations
	config.AllInvariants = true //nolint:staticcheck // keeping old simulations
	config.ChainID = SimAppChainID
